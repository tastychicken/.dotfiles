...
LS_COLORS="${LS_COLORS}:di=01;90:ow=01;90:st=01;90:tw=01;90"

# files
# fi = File, ex = Executable
LS_COLORS="${LS_COLORS}:fi=00;97:ex=01;97"

# links
# ln = Link, mi = Missing
LS_COLORS="${LS_COLORS}:ln=01;32:or=01;32:mi=01;32"

# misc
# pi = Pipe, do = Door, bd = Block, cd = Char, so = Socket, su = SETUID, sg = SETGID
LS_COLORS="${LS_COLORS}:pi=00;41" # red bg
LS_COLORS="${LS_COLORS}:do=00;42" # green bg
LS_COLORS="${LS_COLORS}:bd=00;43:cd=00;43" # orange bg
LS_COLORS="${LS_COLORS}:so=00;44" # blue bg
